...
const FeaturedCourses = () => {
  return (
    <div className="w-full mx-auto bg-white py-10 px-4 md:px-10">
      <div className="flex flex-col items-center bg-gradient-to-r from-[#1a0d29] via-[#0d1033] to-[#1a0d29] text-white px-6 py-8 mt-8 rounded-xl w-full max-w-[90vw] h-[500px]">
